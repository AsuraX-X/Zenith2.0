      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="bg-[#181c1f] rounded-lg border border-gray-600 p-8 mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="text-4xl font-bold text-[#ff1200] mb-2">500+</div>
              <p className="text-gray-300">Weekend Guests Served</p>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-[#ff1200] mb-2">10K+</div>
              <p className="text-gray-300">Happy Customers</p>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-[#ff1200] mb-2">50+</div>
              <p className="text-gray-300">Signature Recipes</p>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-[#ff1200] mb-2">∞</div>
