...
const Reservation = () => {
  return (
    <div className="bg-[url(app/assets/images/unnamed.webp)] h-[50vh] bg-bottom bg-no-repeat bg-cover mt-20">
      <div className="w-full h-full bg-black/40 flex flex-col justify-center px-8 gap-6 items-center">
        <h1 className="text-6xl font-bold">Want to make a reservation?</h1>
        <NavLink
          onClick={() => {
            window.scrollTo(0, 0);
          }}
