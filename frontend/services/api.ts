...
export const signup = (name: string, email: string, password: string, phone: string) =>
...
export const updateOrderStatus = (orderId: string, statusKey: string, value: string) =>
...
export const fetchRiderFinishedDeliveriesAdmin = () =>
  fetch(`${API_BASE}/admin/rider-finished-deliveries`).then(res => res.json());
...
export const fetchRiderCurrentOrders = (riderId: string) =>
  fetch(`${API_BASE}/rider/current-orders/${riderId}`).then(res => res.json());


export const fetchRiderFinishedOrders = (riderId: string) =>
  fetch(`${API_BASE}/rider/finished-orders/${riderId}`).then(res => res.json());
